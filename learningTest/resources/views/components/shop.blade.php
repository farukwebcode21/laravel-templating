        ...
        <div class="container">
            ...
            <div class="vegetables_section_2 layout_padding">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="box_section">
                            <div class="image_4"><img src="{{ asset('images/img-5.png') }}"></div>
                            <h2 class="dolor_text">$<span style="color: #ebc30a;">10</span></h2>
                    ...
                    <div class="col">
                        <div class="box_section">
                            <div class="image_4"><img src="{{ asset('images/img-6.png') }}"></div>
                            <h2 class="dolor_text">$<span style="color: #ebc30a;">10</span></h2>
                    ...
                    <div class="col">
                        <div class="box_section">
                            <div class="image_4"><img src="{{ asset('images/img-7.png') }}"></div>
                            <h2 class="dolor_text">$<span style="color: #ebc30a;">10</span></h2>
                    ...
                    <div class="col">
                        <div class="box_section">
                            <div class="image_4"><img src="{{ asset('images/img-8.png') }}"></div>
                            <h2 class="dolor_text">$<span style="color: #ebc30a;">10</span></h2>
                ...
                <div class="row">
                    <div class="col">
                        <div class="box_section">
                            <div class="image_4"><img src="{{ asset('images/img-9.png') }}"></div>
                            <h2 class="dolor_text">$<span style="color: #ebc30a;">10</span></h2>
                    ...
                    <div class="col">
                        <div class="box_section">
                            <div class="image_4"><img src="{{ asset('images/img-10.png') }}"></div>
                            <h2 class="dolor_text">$<span style="color: #ebc30a;">10</span></h2>
                    ...
                    <div class="col">
                        <div class="box_section">
                            <div class="image_4"><img src="{{ asset('images/img-11.png') }}"></div>
                            <h2 class="dolor_text">$<span style="color: #ebc30a;">10</span></h2>
                    ...
                    <div class="col">
                        <div class="box_section">
                            <div class="image_4"><img src="{{ asset('images/img-12.png') }}"></div>
                            <h2 class="dolor_text">$<span style="color: #ebc30a;">10</span></h2>
                    ...
                    <div class="col">
                        <div class="box_section">
                            <div class="image_4"><img src="{{ asset('images/img-13.png') }}"></div>
                            <h2 class="dolor_text">$<span style="color: #ebc30a;">10</span></h2>
